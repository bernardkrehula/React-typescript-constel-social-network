...
const Login = () => {
    ...
    return(
        <form className='login-page' onSubmit={handleSubmit(onSubmit)}>
            ...
            <h2>Email</h2>
            <SingleInput variation='auth--primary' type='text' name='email' placeholder='Enter your email here...' register={register}/>
            <h2>Password</h2>
            <SingleInput variation='auth--primary' type='text' name='password' placeholder='Enter your password here...' register={register}/>
